...
class RPSEnvironment(Environment):
    ...
    def agent_post_setup(self, agent_list: 'AgentList[RPSAgent]') -> None:
        for agent in agent_list:
            agent.post_setup()

    def market_process(self, agent_list: 'AgentList[RPSAgent]') -> None:
    ...
    def aspiration_update_process(self, agent_list: 'AgentList[RPSAgent]') -> None:
    ...
    def technology_search_process(self, agent_list: 'AgentList[RPSAgent]') -> None:
    ...
    def calculate_average_technology(self, agent_list: 'AgentList[RPSAgent]') -> None:
        sum_tech = 0
        for agent in agent_list:
            sum_tech += agent.technology
        self.average_technology = sum_tech / len(agent_list)

    def calculate_account_total(self, agent_list: 'AgentList[RPSAgent]') -> None:
        sum_account = 0
        for agent in agent_list:
            sum_account += agent.account
        self.average_account = sum_account / len(agent_list)

    def calculate_technology_search_strategy_share(self, agent_list: 'AgentList[RPSAgent]') -> None:
        total_sleep_count = 0
