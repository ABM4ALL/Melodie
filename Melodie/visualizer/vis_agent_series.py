...
class AgentSeries(JSONBase):
    def __init__(self, name: str, type: str, role_getter, roles_repr, color: str='', symbol="rect"):
        self.name: str = name
        self.type: str = type
        self.data: List = []
...
class AgentSeriesManager(JSONBase):
    ...
    def add_series(self, series_name, series_type: str, role_getter: Callable[['Agent'], int], roles_repr, color: str="",
                   symbol: str=""):
