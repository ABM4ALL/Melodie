import random
from typing import ClassVar, Set, Dict, List, Tuple, TYPE_CHECKING, Optional
...
class Grid:
    ...
    def get_neighbor_positions(self, x: int, y: int, radius=1, moore=True, except_self=True) -> List[
        Tuple[int, int]]: ...
    ...
    def move_agent(
            self, agent: GridAgent, target_x, target_y
    ) -> None: ...
    ...
    def get_neighbor_ids(self, x: int, y: int, radius: int = 1,
                         moore=True, except_self=True): ...
