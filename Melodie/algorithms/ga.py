...
class GATrainerParams(AlgorithmParameters):
    def __init__(self, id: int, number_of_path: int, number_of_generation: int, strategy_population: int,
                 mutation_prob: float, strategy_param_code_length: int, **kw):
    ...
    def __hash__(self):
        return hash((self.id, self.number_of_path, self.number_of_generation, self.strategy_population,
                     self.mutation_prob, self.strategy_param_code_length))


class GACalibratorParams(AlgorithmParameters):
    def __init__(self, id: int, number_of_path: int, number_of_generation: int, strategy_population: int,
                 mutation_prob: int, strategy_param_code_length: int, **kw):
        super().__init__(id, number_of_path)
...
class GeneticAlgorithmTrainer(SearchingAlgorithm):
    ...
    def set_parameters_agents(self, agent_num: int,
                              agent_params: int,
