...
which is based the `CovidContagion <https://github.com/ABM4ALL/CovidContagion>`_ model in the :ref:`Tutorial` section.
...
For more details of the ``Network`` module, please refer to the :ref:`Network` section.
