...
class DataCollector1(DataCollector):
    def setup(self):
        ...
        def get_data(model: DCTestModel):
            return {
                "agent1_num": len(model.agent_list1),
                "agent2_num": len(model.agent_list2),
            }
        ...
        self.add_custom_collector(
            "my_collector", get_data, ["agent1_num", "agent2_num"]
        )
        self.add_custom_collector(
            "my_collector2", get_data2, ["agent1_num", "agent2_num"]
        )
