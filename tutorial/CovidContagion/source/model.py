...
class CovidModel(Model):
    ...
    def setup(self):
        ...
        if self.scenario.network_type == "barabasi_albert_graph":
            network_params = {"m": self.scenario.network_param_m}
        elif self.scenario.network_type == "watts_strogatz_graph":
            network_params = {"k": self.scenario.network_param_k,
                              "p": self.scenario.network_param_p}
        else:
            raise NotImplementedError
        self.network.setup_agent_connections([self.agents], self.scenario.network_type, network_params)
